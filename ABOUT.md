...
Legends busca combinar três pilares principais de design.

### Exploração

Cada carta revelada pode trazer **perigo, recompensa ou surpresa**.
...
Cartas de intriga e efeitos especiais criam momentos inesperados e decisões táticas.

O jogo foi projetado para ser:

* simples de aprender
* rápido de jogar
* profundo o suficiente para decisões estratégicas
...
Heróis representam o personagem controlado pelo jogador.

Cada herói possui uma identidade narrativa, enquanto **classes e subclasses definem o estilo de jogo**.
...
Cada classe possui **três especializações**, permitindo estilos únicos de jogo.
...
Monstros representam inimigos encontrados durante a exploração.
...
Equipamentos são cartas permanentes que fortalecem o herói.
...
Legends utiliza uma identidade inspirada em **fantasia caricata e aventura leve**.
...
O jogo segue três princípios fundamentais.
...
Grande diversidade de cartas e encontros.

### Expansibilidade

Novos conteúdos podem ser adicionados facilmente.

O banco de dados do jogo utiliza **JSON**, permitindo criar rapidamente novas cartas e expansões.

---

# FUTURO DO JOGO

Legends foi projetado para crescer.
